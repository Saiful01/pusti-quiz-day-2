    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.applicants.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ans_1') ? 'is-invalid' : '' }}" type="text" name="ans_1" id="ans_1" value="{{ old('ans_1', '') }}">
                @if($errors->has('ans_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ans_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ans_2') ? 'is-invalid' : '' }}" type="text" name="ans_2" id="ans_2" value="{{ old('ans_2', '') }}">
                @if($errors->has('ans_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ans_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ans_3') ? 'is-invalid' : '' }}" type="text" name="ans_3" id="ans_3" value="{{ old('ans_3', '') }}">
                @if($errors->has('ans_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ans_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ans_4') ? 'is-invalid' : '' }}" type="text" name="ans_4" id="ans_4" value="{{ old('ans_4', '') }}">
                @if($errors->has('ans_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ans_4') }}
                    </div>
